...
namespace FiiiChain.Consensus
{
    public class POC
    {
        ...
        const long BLOCK_REWARD_HALVE_STEP = 1000L;//5000000L;
        
        const string SUPER_NODE_PUBLIC_KEY = "302A300506032B65700321005B6F49EEFCD80667BE21AD2437E1EDCE7A464FC6D7FDD76CBAFD40C721463577";

        const long defaultBits = 0x2000FFFF; //0.000001:0x20000F42; //0.0001:1E270FFF; 0.001:0x1E03E7FF; 0.01:0x1D63FFFF; 0.1:0x1D09FFFF; 1:0x1d00FFFF
        public const long DIFFIUCLTY_ADJUST_STEP = 30;//60;
        ...
        public static long CalculateBaseTarget(long currentHeight, BlockMsg prevBlockMsg, BlockMsg prevStepBlockMsg)
        {
            ...
            {
                return prevBlockMsg.Header.Bits;
            }
            else
            {
                ...
                var actualTimespan = prevBlockMsg.Header.Timestamp - prevStepBlockMsg.Header.Timestamp;
